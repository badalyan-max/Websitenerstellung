        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/80 backdrop-blur-sm rounded-full border border-primary-100 shadow-sm mb-8 animate-fade-in">
              ...
              <span className="text-sm text-secondary-500">({COMPANY_DATA.rating.count} Bewertungen)</span>
            </div>
          ...
          <div className="relative lg:pl-8">
            {/* Main Card */}
            <div className="relative bg-white rounded-3xl shadow-2xl shadow-secondary-900/10 p-8 border border-secondary-100">
              {/* Decorative Elements */}
              ...
              <div className="relative grid grid-cols-2 gap-4 mb-6">
                {[
                  ...
                  <div
                    key={idx}
                    className="flex items-center gap-3 p-4 bg-gradient-to-br from-secondary-50 to-white rounded-xl border border-secondary-100 hover:border-primary-200 hover:shadow-md transition-all duration-300 group cursor-pointer"
                  >
              ...
              <div className="grid grid-cols-3 gap-4 pt-6 border-t border-secondary-100">
                <div className="text-center">
                  ...
                  <div className="text-xs text-secondary-500">Zufriedene Kunden</div>
                </div>
                <div className="text-center border-x border-secondary-100">
                  <div className="text-2xl font-bold text-primary-600">32</div>
                  <div className="text-xs text-secondary-500">Standorte</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-primary-600">24/7</div>
                  <div className="text-xs text-secondary-500">Erreichbar</div>
                </div>
              </div>

              {/* Floating Badge */}
              <div className="absolute -bottom-6 left-1/2 -translate-x-1/2 bg-gradient-to-r from-primary-500 to-primary-600 text-white px-6 py-3 rounded-full shadow-lg shadow-primary-500/30 flex items-center gap-2">
                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                </svg>
                <span className="text-sm font-semibold">30-Tage-Garantie</span>
              </div>
            </div>

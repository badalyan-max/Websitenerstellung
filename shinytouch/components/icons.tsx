/**
 * Professional SVG Icons for ShinyTouch
 * Replaces emojis with clean, professional vector icons
 */
...
export function WindowIcon(props: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      ...
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 8.25v12m-6.75-6h13.5" />
    </svg>
  )
}
...
export function EcoLeafIcon(props: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
...
// Service Icon Mapping (for use in services.ts replacement)
export const SERVICE_ICONS = {
  bueroreinigung: BuildingOfficeIcon,
  glasreinigung: WindowIcon,
  grundreinigung: SparklesIcon,

...
export default async function CityPage({ params }: CityPageProps) {
  ...
  const highlights = generateCityHighlights(city)
  const faqs = generateCityFAQs(city)

  const breadcrumbs = [
    { name: 'Home', url: '/' },
    { name: 'Einsatzorte', url: '/einsatzorte' },
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <nav className="mb-8" aria-label="Breadcrumb">
            <ol className="flex items-center gap-2 text-sm text-secondary-500">
              ...
              <li>/</li>
              <li>
                <Link href="/einsatzorte" className="hover:text-primary-600 transition-colors">
                  Einsatzorte
                </Link>
              </li>
              <li>/</li>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/80 backdrop-blur-sm rounded-full border border-primary-100 shadow-sm mb-6">
                ...
                {city.plz && (
                  <span className="text-sm text-secondary-500 font-mono">{city.plz}</span>
                )}
              </div>
              ...
              <p className="text-lg text-secondary-600 mb-8 leading-relaxed">{intro}</p>
              ...
              <div className="bg-white rounded-3xl shadow-2xl shadow-secondary-900/10 p-8 border border-secondary-100">
                ...
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-secondary-500">5 von 5 Sternen</div>
                  </div>
                </div>
      ...
      <section className="py-20 lg:py-28 bg-gradient-to-br from-primary-600 via-primary-700 to-primary-800">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-primary-100 mb-10">
            Fordern Sie jetzt Ihr kostenloses Angebot für {city.name} an. Wir melden uns innerhalb
